...
?>
    <div class="contenedor">
        ...
        <div class="navega">
            ...
            <div class="inicio activemas" style="padding-left: 0px;"><a href="../../Pagehome/vistas/index.php"><div class="espacii"><box-icon type='solid' name='dashboard'></box-icon>VER DASHBOARD</div></a></div> 
